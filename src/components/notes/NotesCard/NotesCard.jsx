...
function NotesCard({ notesId, title, text, date, isArchived, isDeleted, deleteHandler, archiveHandler}) {
    return (
        <article className="note-item">
            ...
            <div className="note-item__meta">
                ...
                <div className="note-item__actions">
                    <button className='note-item__actions-delete' onClick={deleteHandler}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0z" fill="none" />
                            <path fill="#e64e35" d="M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6zM8 9h8v10H8zm7.5-5l-1-1h-5l-1 1H5v2h14V4z" />
                        </svg>
                    </button>
                    <button className='note-item__actions-archive' onClick={archiveHandler}>
